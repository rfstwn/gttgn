<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-success d-flex text-white justify-content-between align-items-center">
                    <h5 class="mb-0">Tambah Transportasi</h5>
                </div>
                
                <div class="card-body">
                    <form action="<?= base_url('admin-gttgn/dashboard/save_transportation') ?>" method="post">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= form_error('icon') ? 'is-invalid' : '' ?>" 
                                           id="icon" name="icon" value="<?= set_value('icon') ?>" placeholder="Contoh: fa-solid fa-car fa-2xl">
