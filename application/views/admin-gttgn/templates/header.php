...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar__menu">
            ...
            <li><a href="<?php echo base_url('admin-gttgn/user-admin'); ?>"><i class="fas fa-users-cog mr-2"></i> Manajemen Admin</a></li>
            <li><a href="<?php echo base_url('admin-gttgn/user-data'); ?>"><i class="fas fa-users mr-2"></i> Data Registrasi User</a></li>
            <li><a href="<?php echo base_url('admin-gttgn/hotels'); ?>"><i class="fas fa-hotel mr-2"></i> Halaman Hotel</a></li>
            <li><a href="<?php echo base_url('admin-gttgn/informasi'); ?>"><i class="fas fa-train mr-2"></i>Halaman Informasi</a></li>
            ...
            <li><a href="<?php echo base_url('admin-gttgn/contact-info'); ?>"><i class="fas fa-info-circle mr-2"></i> Halaman Kontak</a></li>
            <li><a href="<?php echo base_url('admin-gttgn/contact-submissions'); ?>"><i class="fas fa-envelope mr-2"></i> Pesan Kontak</a></li>
        </ul>
