<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= base_url('admin-gttgn/informasi/add_transportation_process') ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="image_file" class="form-label">Upload Gambar <span class="text-danger">*</span></label>
                            <input type="file" class="form-control <?= form_error('image_file') ? 'is-invalid' : '' ?>" 
                                    id="image_file" name="image_file" accept="image/*" onchange="previewImage(this)" required>
                            <div class="form-text">Upload gambar transportasi (JPG, PNG, GIF). Ukuran optimal: 400x300px.</div>
